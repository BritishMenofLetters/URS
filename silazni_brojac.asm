//SMANJI_R0:
	...
	//Provjeri je li zarez na bit 4
	sbrs r7, 4 //Ako je zarez na 4, nemoj zavrsiti
	jmp KRAJ_DEKREMENTA
	
	//Ako je zarez na 4, provjeri je li R1 nula
	mov r16, r1
	cpi r16, 0x03
...
SMANJI_R4:
	...
	cpi r16, 0x03	//Ako je R4 nula i zarez je na bit 3 (R4 R3 , R2 R1), prebaci zarez u lijevo
	BRNE KRAJ_DEKREMENTA	//Ako nije nula, zavrsi

	sbrc r7, 3		//Ako zarez nije na bit 3, skipaj pomak zareza
	lsl r7
...
SMANJI_R5:
	...
	cpi r16, 0x03	//Ako je R5 nula i zarez je na bit 2 (R5 R4 R3 , R2), prebaci zarez u lijevo
	BRNE KRAJ_DEKREMENTA	//Ako nije nula, zavrsi
...
SMANJI_R6:
	...
	cpi r16, 0x03			//Ako je R6 nula i zarez je na bit 1 (R6 R5 R4 R3 ,), prebaci zarez u lijevo
	BRNE KRAJ_DEKREMENTA	//Ako nije nula, zavrsi
